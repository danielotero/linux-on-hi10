...
static const struct {
	...
	.fuzz_x = 7,
	.fuzz_y = 7,
	.firmware_name = "gsl1680-chuwi-hi10-pro.fw",
	.max_fingers = 10,
	.home_button = true,
	.inverted_x = false,
	.inverted_y = false
...
static void touchscreen_custom_properties(struct input_dev *input,
					  bool multitouch,
					  struct touchscreen_properties *prop)
{
	...
	minimum = touchscreen_properties.min_x;
	maximum = touchscreen_properties.size_x;
	fuzz = touchscreen_properties.fuzz_x;
	touchscreen_set_params(input, axis, minimum, maximum - 1, fuzz);

	axis = multitouch ? ABS_MT_POSITION_Y : ABS_Y;
	minimum = touchscreen_properties.min_y;
	maximum = touchscreen_properties.size_y;
	fuzz = touchscreen_properties.fuzz_y;
	touchscreen_set_params(input, axis, minimum, maximum - 1, fuzz);
	...
	prop->invert_x = touchscreen_properties.inverted_x;
	if (prop->invert_x) {
	...
	prop->invert_y = touchscreen_properties.inverted_y;
	if (prop->invert_y) {
	...
	prop->swap_x_y = touchscreen_properties.swapped_x_y;
	if (prop->swap_x_y)
...
static int silead_ts_request_input_dev(struct silead_ts_data *data)
{
	...
	touchscreen_custom_properties(data->input, true, &data->prop);
